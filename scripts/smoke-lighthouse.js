...
expect(typeof lighthouse['2'] === 'object' && typeof lighthouse['2']._ === 'string' && lighthouse['2']._.startsWith('marks'), 'position 2 is marks sub-block with underscore starting "marks"');
expect(typeof lighthouse['2']['1'] === 'string' && lighthouse['2']['1'].startsWith('tide'), 'tide reference at 2.1');
